...
try:
    ...
    # 统计
    print(f"\n[OK] 景点总数：{len(SCENIC_SPOTS)} 个")
    print(f"[OK] 旅游贴士：{len(TRAVEL_TIPS)} 条")
    print(f"[OK] 分类索引：{len(CATEGORY_INDEX)} 个分类")
    print(f"[OK] 行政区划：{len(DISTRICT_STATS)} 个区域")
